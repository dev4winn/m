(function () {
    ...
    (function () {
        ...
        document.body.style.background = "#000000 url('res/LoadingUI/logo.png') no-repeat center center fixed";
        ...
        // var linkURL = document.createElement("IMG");
        // linkURL.setAttribute("id","linkURL");
        // linkURL.setAttribute("src", "res/LoadingUI/manvipclub.png");
        // linkURL.setAttribute("width", "224");
        // linkURL.setAttribute("height", "24");
        // linkURL.style.position = "absolute";
        // linkURL.style.marginLeft = "calc(50% - 112px)";
        // linkURL.style.marginTop = '550px';
        // linkURL.setAttribute("margin");
        // document.body.appendChild(linkURL);
        // var linkURL1 = document.createElement("IMG");
        // var list = createDom();
